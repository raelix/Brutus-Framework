...
import net.modbus.io.NonWordDataHandler;
import net.modbus.procimg.IllegalAddressException;
import net.modbus.procimg.ProcessImage;
import net.modbus.procimg.ProcessImageFactory;
	...
	public ModbusResponse createResponse() {
		...
		if (m_NonWordDataHandler == null) {
			...
			try {
				...
				//    	  propertyChangeSupport.firePropertyChange(""+Modbus.WRITE_MULTIPLE_REGISTERS,""+this.getReference(),this.getWordCount());
