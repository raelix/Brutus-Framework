...
public final class HalfThermometer extends View {

	private static final String TAG = HalfThermometer.class.getSimpleName();
	...
	public HalfThermometer(Context context) {
		super(context);
		init(context, null);
	}

	public HalfThermometer(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs);
	}

	public HalfThermometer(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initDrawingTools() {
		...
		rimPaint.setShader(new LinearGradient(0.40f, 0.0f, 0.60f, 1.0f, getResources().getColor(R.color.blue_400),getResources().getColor(R.color.blue_300),Shader.TileMode.CLAMP));		
		rimPaint.setColor(getResources().getColor(R.color.blue_300));
		rimCirclePaint = new Paint();
		rimCirclePaint.setAntiAlias(true);
		rimCirclePaint.setStyle(Paint.Style.STROKE);
		rimCirclePaint.setColor(Color.argb(0x4f, 0x33, 0x36, 0x33));
		rimCirclePaint.setStrokeWidth(0.015f);
		float rimSize = 0.055f;
		faceRect = new RectF();
		faceRect.set(rimRect.left + rimSize, rimRect.top + rimSize, rimRect.right - rimSize, rimRect.bottom - rimSize);		
		faceTexture = BitmapFactory.decodeResource(getContext().getResources(), 	R.drawable.brushed_alu);
		...
		rimShadowPaint.setShader(new RadialGradient(0.5f, 0.5f, faceRect.width() / 2.0f, new int[] { 0x00000000, 0x00000500, 0x50000500 },new float[] { 0.96f, 0.96f, 0.99f },Shader.TileMode.MIRROR));
		rimShadowPaint.setStyle(Paint.Style.FILL);
		scalePaint = new Paint();
		scalePaint.setStyle(Paint.Style.STROKE);
//		scalePaint.setColor(scaleColor);
		scalePaint.setColor(getResources().getColor(R.color.blue_500));
		...
		float titlePosition = 0.150f;
		titleRect = new RectF();
		titleRect.set(faceRect.left  + titlePosition, faceRect.top    + titlePosition,faceRect.right - titlePosition, faceRect.bottom - titlePosition);
		titlePaint = new Paint();
//		titlePaint.setColor(0xaf946109);
		titlePaint.setColor(getResources().getColor(R.color.blue_800));
...
//		handPath.lineTo(0.5f - 0.010f, 0.5f + 0.2f - 0.007f);
		handPath.lineTo(0.5f - 0.032f, 0.5f );
		handPath.lineTo(0.5f + 0.032f, 0.5f);
//		handPath.lineTo(0.5f + 0.010f, 0.5f + 0.2f - 0.007f);
...
//		canvas.drawOval(rimRect, rimPaint);
		canvas.drawArc(rimRect,180f,180f,true,rimPaint); 
//		canvas.drawOval(rimRect, rimCirclePaint);
		canvas.drawArc(rimRect,180f,180f,true,rimCirclePaint);
	}
...
//		canvas.drawOval(faceRect, rimShadowPaint);
		canvas.drawArc(faceRect,180f,180f,true, facePaint);
		canvas.drawArc(faceRect,180f,180f,true, rimCirclePaint);
		canvas.drawArc(faceRect,180f,180f,true, rimShadowPaint);
	}
...
//		if(totalNotches % 3 == 0 )++totalNotches;
		for (int i = 0; i < totalNotches; ++i) {
			...
			if (incrementPerLargeNotch > 1 && i % (incrementPerLargeNotch/incrementPerSmallNotch) == 0 ) {
...
//		drawLogo(canvas);
	...
	public HalfThermometer getView(){
		return this;
	}
