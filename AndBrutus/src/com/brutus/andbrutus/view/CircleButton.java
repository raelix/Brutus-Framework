...
public class CircleButton extends ImageView {
	...
	public void setPressed(boolean pressed) {
		...
		if (pressed) {
			showPressedRing();
			//			new SimpleAnimation().createCircularRevealAnimation(this, 0);
		} else {
			hidePressedRing();
		}
	}
	...
	private void hidePressedRing() {
		...
		scaleY.setDuration(getResources().getInteger(ANIMATION_TIME_ID));
		scaleY.setDuration(getResources().getInteger(ANIMATION_TIME_ID));
		pressedAnimator.setFloatValues(pressedRingWidth, 0f);
		set.playTogether(scaleX,scaleY,pressedAnimator);
		set.start();
	}
	...
	private void showPressedRing() {
		AnimatorSet set = new AnimatorSet();
		scaleX = ObjectAnimator.ofFloat(this, "scaleX", 0.7f);
		scaleY = ObjectAnimator.ofFloat(this, "scaleY", 0.7f);
		scaleY.setDuration(getResources().getInteger(ANIMATION_TIME_ID));
		scaleY.setDuration(getResources().getInteger(ANIMATION_TIME_ID));
