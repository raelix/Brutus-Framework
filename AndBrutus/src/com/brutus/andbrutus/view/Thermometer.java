...
public final class Thermometer extends View {
	...
	public String scaleUpperTitle = "";
	public String scaleLowerTitle = "";
...
//		scalePaint.setColor(scaleColor);
		...
		scalePaint.setTypeface(Typeface.createFromAsset(getContext().getAssets(), "Roboto-Light.ttf"));
...
//		titlePaint.setColor(0xaf946109);
		...
		titlePaint.setTypeface(Typeface.createFromAsset(getContext().getAssets(), "Roboto-Regular.ttf"));
		titlePaint.setTextAlign(Paint.Align.CENTER);
		titlePaint.setTextSize(0.05f);
		titlePaint.setTextScaleX(0.9f);
		titlePaint.setStrokeWidth(0.004f);
		//titlePath = new Path();
...
//		canvas.drawTextOnPath("Watt", titleLowerPath, 0.0f, 0.06f, titlePaint);			
	}
