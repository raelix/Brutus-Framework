...
public class FloatingActionsMenu extends ViewGroup {
	...
	@Deprecated
	public void setMenuButtonBackgroundColor(int color){
		this.mAddButton.mPlusColor = color;
	}

	public void setIcon(int res){
		mAddButton.setIcon(res);
	}

	public void setPlusColor(int color){
		this.mAddButtonPlusColor = color;
	}

	public void setRotationEnable(boolean rotation){
	...
	public void setColorNormal(int color){
		...
		if(mAddButton != null){
			mAddButton.mColorNormal = color;
			mAddButton.mPlusColor = color;
	...
	public void setColorPressed(int color){
		...
		if(mAddButton != null){
			mAddButton.mColorPressed = color;
			mAddButton.updateBackground();
		}
	}
	...
	private static class RotatingDrawable extends LayerDrawable {
		boolean rotationEnable = true;
		private float mRotation;

		public RotatingDrawable(Drawable drawable) {
			super(new Drawable[] { drawable });
		}
		public RotatingDrawable(Drawable drawable,boolean rotate) {
			super(new Drawable[] { drawable });
			this.rotationEnable = rotate;
		}
	...
	private void createAddButton(Context context) {
		mAddButton = new AddFloatingActionButton(context) {
			...
			Drawable getIconDrawable() {
				final RotatingDrawable rotatingDrawable = new RotatingDrawable(super.getIconDrawable(),rotate);
